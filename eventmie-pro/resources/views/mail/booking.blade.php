...
**{{ __('eventmie-pro::em.timings') }}:** {{ userTimezone($mail_data->mail_data[0]['event_start_date'].' '.$mail_data->mail_data[0]['event_start_time'], 'Y-m-d H:i:s', 'h:i A')  }} - {{ userTimezone($mail_data->mail_data[0]['event_end_date'].' '.$mail_data->mail_data[0]['event_end_time'], 'Y-m-d H:i:s', 'h:i A') }} {{ '('. showTimezone() .')' }}  <br>

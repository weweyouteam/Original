                            ...
                            <table>
                                ...
                                <tr>
                                    <td class="text-left">
                                        ...
                                        {{ '('.userTimezone($booking['event_start_date'].' '.$booking['event_start_time'], 'Y-m-d H:i:s', 'h:i A').' - '.userTimezone($booking['event_end_date'].' '.$booking['event_end_time'], 'Y-m-d H:i:s', 'h:i A').')' }}

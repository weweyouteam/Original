                    ...
                    <div class="col-md-6 table-responsive">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tr>
                                ...
                                <td>{{ userTimezone($booking['event_start_date'].' '.$booking['event_start_time'], 'Y-m-d H:i:s', 'Y-m-d')}}
                                    {{ '('. showTimezone() .')' }}
                                </td>
                            </tr>   
                            ...
                            <tr>
                                ...
                                @if( userTimezone($booking['event_start_date'].' '.$booking['event_start_time'], 'Y-m-d H:i:s', 'Y-m-d') <= userTimezone($booking['event_end_date'].' '.$booking['event_end_time'], 'Y-m-d H:i:s', 'Y-m-d'))
                                    ...
                                    <td>{{ userTimezone($booking['event_end_date'].' '.$booking['event_end_time'], 'Y-m-d H:i:s', 'Y-m-d')}}
                                        {{ '('. showTimezone() .')' }}
                                    </td>
                                @else
                                    <td>{{ userTimezone($booking['event_start_date'].' '.$booking['event_start_time'], 'Y-m-d H:i:s', 'Y-m-d')}}
                            ...
                            <tr>
                                ...
                                <td>{{ userTimezone($booking['event_start_date'].' '.$booking['event_start_time'], 'Y-m-d H:i:s', 'h:i A') }}
                                    {{ '('. showTimezone() .')' }}
                                </td>
                            </tr>   
                            ...
                            <tr>
                                ...
                                <td>{{ userTimezone($booking['event_end_date'].' '.$booking['event_end_time'], 'Y-m-d H:i:s', 'h:i A') }}
                                    {{ '('. showTimezone() .')' }}
                                </td>
                            </tr>   
                            <tr>
                                <th>@lang('eventmie-pro::em.booking_date')</th>
                                <td>{{ userTimezone($booking['created_at'], 'Y-m-d H:i:s', 'Y-m-d') }}
                                    {{ '('. showTimezone() .')' }}
                                </td>
                            </tr>    
